...
<form action="{base}/themes/create/?ns=controllers&amp;path=controller_path" class="form themeForm" method="post">
	...
	<fieldset>
		<Legend>Maak Thema!</Legend>
		<div class="control-group">
			<div class="controls">
				<input type="submit" name="submit" value="Maak Thema" class="btn btn-primary btn-large">
			</div>
		</div>
	</fieldset>
</form>
