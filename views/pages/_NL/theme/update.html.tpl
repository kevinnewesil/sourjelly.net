...
<form action="{base}/themes/update/{id}/?ns=controllers&amp;path=controller_path" class="form themeForm" method="post">
	<fieldset>
		<legend>Thema naam</legend>
		<input type="hidden" name="id" value="{id}">
		<div class="control-group">
			<label for="themeName" class="control-label">Thema naam</label>
			<div class="controls">
				<input type="text" name="themeName" id="themeName" value="{themeName}" placeholder="Thema naam">
			</div>
		</div>
	</fieldset>
	<fieldset>
		<legend>Kleuren : Grijs &amp; Accent kleuren</legend>
		<div class="row">
			<!-- Grays -->
			<div class="span4">
				<div class="control-group">
	...
	<fieldset>
		<legend>Typography : lettertype, lettergrote &amp; titels</legend>
		<div class="row">
			<!-- Typography -->
	...
	<fieldset>
		<legend>Tabellen &amp; Formulieren</legend>
		<div class="row">
	...
	<fieldset>
		<Legend>Navigatie bar, Navigatie bar-inverse &amp; Dropdown menu's</Legend>
	...
	<fieldset>
		<legend>Z-index Master Lijst</legend>
		<div class="row">
	...
	<fieldset>
		<legend>Pagina verdeling &amp; Hero unit</legend>
		<div class="row">
	...
	<fieldset>
		<legend>Formulier statussen &amp; meldingen</legend>
		<div class="row">
	...
	<fieldset>
		<legend>Tooltips &amp; popovers</legend>
		<div class="row">
	...
	<fieldset>
		<legend>Grid : standaart 940px grid, 1200px min &amp; 768-979px</legend>
		<div class="row">
	...
	<fieldset>
		<Legend>Update Thema!</Legend>
		<div class="control-group">
			<div class="controls">
				<input type="submit" name="submit" value="Update thema" class="btn btn-primary btn-large">
			</div>
		</div>
	</fieldset>
</form>
